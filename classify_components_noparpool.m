function [rval_space,rval_time,max_pr,sizeA,keep] = classify_components_noparpool(Y,A,C,b,f,YrA,options)
...
[rval_space,rval_time,ind_space,ind_time] = classify_comp_corr_noparpool(Y,A,C,b,f,options);
